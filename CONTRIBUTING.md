...
- Create an [issue](https://github.com/codersrank-org/summary-widget/issues) on GitHub, if you have found a bug
...
- Submit an [issue](https://github.com/codersrank-org/summary-widget/issues), assuming one does not already exist.
